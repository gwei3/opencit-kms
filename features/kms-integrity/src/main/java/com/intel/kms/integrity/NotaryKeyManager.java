...
public class NotaryKeyManager implements Closeable {
    ...
    public static final String NOTARY_KEYSTORE_PASSWORD_PROPERTY = "notary.keystore.password";
    ...
    public static final String NOTARY_DEFAULT_KEYSTORE_PASSWORD = "notary"; // the password alias in the vault, not the actual password
    ...
    public NotaryKeyManager(Configuration configuration) throws IOException, KeyStoreException {
        ...
        keystorePasswordAlias = configuration.get(NOTARY_KEYSTORE_PASSWORD_PROPERTY, NOTARY_DEFAULT_KEYSTORE_PASSWORD);
