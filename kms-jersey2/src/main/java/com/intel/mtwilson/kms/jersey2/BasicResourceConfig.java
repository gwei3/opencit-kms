 ...
 * All rights reserved.
 */
package com.intel.mtwilson.kms.jersey2;
...
public class BasicResourceConfig extends ResourceConfig {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BasicResourceConfig.class);
    
    public BasicResourceConfig() {
        log.debug("Registering JAX-RS features");
...
//        register(com.intel.mtwilson.jaxrs2.server.filter.ErrorLogFilter.class);
        ...
        log.debug("Registering resource packages");
//        packages("com.intel.kms.keystore.jaxrs","com.intel.kms.keystore.html5.jaxrs");
//        packages();
    }
