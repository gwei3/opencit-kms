...
public class MtWilsonV2Client implements SecurityAssertionProvider {
    ...
    public boolean isReportValid(String saml) throws IOException, KeyManagementException, ApiException, KeyStoreException, NoSuchAlgorithmException, UnrecoverableEntryException, CertificateEncodingException {
        HostAttestations client = getMtWilsonClient();
