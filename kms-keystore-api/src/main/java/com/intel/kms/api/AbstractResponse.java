...
public abstract class AbstractResponse implements Faults {
    ...
    /**
     * The httpResponse member does NOT get serialized in responses, it
     * exists so that a "business layer" object can provide hints on 
     * the content type and status of the response without preempting
     * other processing or losing other response information by throwing an exception
     */
