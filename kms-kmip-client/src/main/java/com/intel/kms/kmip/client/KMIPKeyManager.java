...
public class KMIPKeyManager implements KeyManager {
	...
	public void setupKeyStore(Configuration configuration) throws IOException,
			KeyStoreException {
	...
	public TransferKeyResponse transferKey(TransferKeyRequest request) {
		...
		} catch (KMIPClientException | InvalidKeyException
	...
	/**
	 * 
	 * @param kmipCreatedKey
	 *            the raw key material returned from kmip
	 * @param algorithm
	 *            for example "AES"
	 * @param keyLengthBits
	 *            for example 128, 192, or 256 for AES
	 * @return
