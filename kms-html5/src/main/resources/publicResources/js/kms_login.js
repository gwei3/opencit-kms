...
function LoginViewModel() {
    ...
    self.login = function(loginFormElement) {
        ...
        console.log("Login request: %O", ko.toJSON(self.loginRequest)); // attempting to serialize loginRequestItem produces errors, probably because it represents the entire form
