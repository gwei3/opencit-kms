...
public class NotaryKey extends AbstractSetupTask {
    ...
    protected void configure() throws Exception {
        NotaryKeyManager notary = new NotaryKeyManager(getConfiguration());
    ...
    protected void execute() throws Exception {
        ...
        if (!keystorePasswordAlias.equals(NotaryKeyManager.NOTARY_DEFAULT_KEYSTORE_PASSWORD)) {
            getConfiguration().set(NotaryKeyManager.NOTARY_KEYSTORE_PASSWORD_PROPERTY, keystorePasswordAlias);
        }
