...
import com.intel.kms.EnvelopeKeyManager;
...
public class EnvelopeKey extends AbstractSetupTask {
    ...
    // constants
    private static final String ENVELOPE_KEYSTORE_FILE_PROPERTY = "envelope.keystore.file";
    private static final String ENVELOPE_KEYSTORE_PASSWORD_PROPERTY = "envelope.keystore.password";
    // configuration keys
    ...
    protected void configure() throws Exception {
        keystorePath = getConfiguration().get(ENVELOPE_KEYSTORE_FILE_PROPERTY, Folders.configuration() + File.separator + "envelope.p12");
        keystorePasswordAlias = getConfiguration().get(ENVELOPE_KEYSTORE_PASSWORD_PROPERTY, "envelope_keystore");
    ...
    protected void validate() throws Exception {
        ...
        try (EnvelopeKeyManager envelopeKeyManager = new EnvelopeKeyManager(keystoreFile, keystorePassword.toCharArray())) {
    ...
    protected void execute() throws Exception {
        ...
        getConfiguration().set(ENVELOPE_KEYSTORE_FILE_PROPERTY, keystorePath);
        getConfiguration().set(ENVELOPE_KEYSTORE_PASSWORD_PROPERTY, keystorePasswordAlias);
