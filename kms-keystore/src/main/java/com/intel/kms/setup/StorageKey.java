...
import com.intel.kms.StorageKeyManager;
...
//    private int storageKeyLengthBits;
    ...
    protected void configure() throws Exception {
        keystorePath = getConfiguration().get(KMS_STORAGE_KEYSTORE_FILE_PROPERTY, Folders.configuration() + File.separator + "storage.jck");
        keystorePasswordAlias = getConfiguration().get(KMS_STORAGE_KEYSTORE_PASSWORD_PROPERTY, "storage_keystore");
...
//        storageKeyLengthBits = storageKeyManager.getStorageKeyLengthBits();
    ...
    protected void validate() throws Exception {
        ...
        try (StorageKeyManager storageKeyManager = new StorageKeyManager(keystoreFile, keystorePassword.toCharArray())) {
    ...
    protected void execute() throws Exception {
        ...
        getConfiguration().set(KMS_STORAGE_KEYSTORE_FILE_PROPERTY, keystorePath);
        getConfiguration().set(KMS_STORAGE_KEYSTORE_PASSWORD_PROPERTY, keystorePasswordAlias);
    }
}
